 ...
 */
router.get('/course/:courseId', ModulesController.getByField('course_id', 'courseId'));

/**
 * Returns all modules with the specified instructor.
 * @param {string} instructorId - The UUID of the instructor
 */
router.get('/instructor/:instructorId', ModulesController.getByField('instructor_id', 'instructorId'));
